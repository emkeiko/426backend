...
var corsOption = {
    origin: 'https://edwinz47.github.io',
    credentials:true
}
...
app.use(expressSession({
    ...
    cookie : {
        sameSite: "none",
        secure : true, // it works without the secure flag (cookie is set)  // tried using this as well, no difference
...
const port = process.env.PORT || 3000 // change based on heroku later; 19:30 of kmp video
app.listen(port, () => {
